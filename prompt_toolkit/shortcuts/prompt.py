...
class PromptSession(object):
    ...
    def _get_line_prefix(self, width, line_number, is_soft_wrap,
                         get_prompt_text_2):
        """
        ...
        if line_number == 0 and not is_soft_wrap:
        ...
        return self._get_continuation(prompt_width, line_number, is_soft_wrap)
